...
<a href="#" class="service-offer-booking excur-offer-button" id="excur-offer-button" data-toggle="modal" data-target=".bs-example-pay"></a>
...
<div id="pay-form-step-one">
</div>
  <div id="pay-form-step-two">
  </div>
</div>